/**
 * helpers/enricher/enricher.js
 * node helpers/enricher/enricher.js       - default; run the enricher to enrich the database
 * node helpers/enricher/enricher.js validate - run a read-only dry run against a random entry
 * node helpers/enricher/enricher.js merge - truncate db-shm and db-wal and merge to .db
 */
